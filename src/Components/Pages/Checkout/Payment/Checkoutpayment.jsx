                    ...
                    <div className="col-12 col-xl-8">
                      <div className="checkout-payment">
                        ...
                        <div className="card rounded-0 shadow-none border">
                          ...
                          <div className="card-body">
                            <ul
                              className="nav nav-pills mb-3 border p-3"
                              role="tablist"
                            >
                                ...
                                >
                                  <div className="d-flex  align-items-center ">
                                    <div className="tab-icon">
                                      <i className="bx bx-credit-card  font-18 me-1" />
                                    </div>
                                    <div className="tab-title btn-dark">Credit Card</div>
                                  </div>
                                </a>
                              </li>
                              <li className="nav-item" role="presentation">
                                ...
                                >
                                  <div className="d-flex align-items-center">
                                    <div className="tab-icon">
                                      <i className="bx bxl-paypal font-18 me-1" />
                                    </div>
                              ...
                              <li className="nav-item" role="presentation">
                                ...
                                >
                                  <div className="d-flex align-items-center">
                                    <div className="tab-icon">
                                      <i className="bx bx-mobile font-18 me-1" />
                                    </div>
                            ...
                            <div className="tab-content" id="pills-tabContent">
                                    ...
                                    <div className="mb-3">
                                      ...
                                      <div className="input-group">
                                        <input
                                          type="text"
                                          className="form-control rounded-0"
                                          placeholder="Valid Owner number"
                                        />{" "}
                              ...
                              >
                                <div className="p-3 border">
                                  ...
                                  <div className="mb-3">
                                    <p className="mb-0">
                                      Note: After clicking on the button, you
                                      will be directed to a secure gateway for
