            ...
            <div className="page-wrapper">
                ...
                <section className="py-4">
                        ...
                        <div className="col-12 col-xl-8">
                            ...
                            <div className="card rounded-0 shadow-none">
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-6">
                                    <div className="d-grid">
                                        <a href="/payment" className="btn btn-dark btn-ecomm">Proceed to Payment<i className="bx bx-chevron-right" /></a>
                                    </div>
                                    </div>
                                </div>
                                </div>
                    ...
                    <div className="card rounded-0">
                        ...
                        <div className="card rounded-0 border bg-transparent shadow-none overflow-auto " style={{ maxHeight: '182px' }}>
                            <div className="card-body ">
