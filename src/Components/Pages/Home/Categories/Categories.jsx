   ...
   <section className="py-4">
      <div className="container">
        <div className="separator pb-4">
          <div className="line" />
          <h5 className="mb-0 fw-bold separator-title">Browse Catergory</h5>
          <div className="line" />
        </div>
          ...
          <div className="browse-category owl-carousel owl-theme">
            <div className="item">
              <div className="card rounded-0">
                ...
                <div className="card-footer text-center bg-transparent border">
                  <h6 className="mb-0 text-uppercase fw-bold">Fashion</h6>
            ...
            <div className="item">
              <div className="card rounded-0">
                ...
                <div className="card-footer text-center bg-transparent border">
                  <h6 className="mb-1 text-uppercase fw-bold">Watches</h6>
            ...
            <div className="item">
              <div className="card rounded-0">
                ...
                <div className="card-footer text-center bg-transparent border">
                  <h6 className="mb-1 text-uppercase fw-bold">Shoes</h6>
            ...
            <div className="item">
              <div className="card rounded-0">
                ...
                <div className="card-footer text-center bg-transparent border">
                  <h6 className="mb-1 text-uppercase fw-bold">Bags</h6>
            ...
            <div className="item">
              <div className="card rounded-0">
                ...
                <div className="card-footer text-center bg-transparent border">
                  <h6 className="mb-1 text-uppercase fw-bold">Electronis</h6>
                  <p className="mb-0 font-12 text-uppercase">6 Products</p>
                </div>
              </div>
            </div>
            <div className="item">
              <div className="card rounded-0">
                ...
                <div className="card-footer text-center bg-transparent border">
                  <h6 className="mb-1 text-uppercase fw-bold">Headphones</h6>
            ...
            <div className="item">
              <div className="card rounded-0">
                ...
                <div className="card-footer text-center bg-transparent border">
                  <h6 className="mb-1 text-uppercase fw-bold">Furniture</h6>
            ...
            <div className="item">
              <div className="card rounded-0">
                ...
                <div className="card-footer text-center bg-transparent border">
                  <h6 className="mb-1 text-uppercase fw-bold">Jewelry</h6>
            ...
            <div className="item">
              <div className="card rounded-0">
                ...
                <div className="card-footer text-center bg-transparent border">
                  <h6 className="mb-1 text-uppercase fw-bold">Sports</h6>
            ...
            <div className="item">
              <div className="card rounded-0">
                ...
                <div className="card-footer text-center bg-transparent border">
                  <h6 className="mb-1 text-uppercase fw-bold">Vegetable</h6>
            ...
            <div className="item">
              <div className="card rounded-0">
                ...
                <div className="card-footer text-center bg-transparent border">
                  <h6 className="mb-1 text-uppercase fw-bold">Medical</h6>
            ...
            <div className="item">
              <div className="card rounded-0">
                ...
                <div className="card-footer text-center bg-transparent border">
                  <h6 className="mb-1 text-uppercase fw-bold">Sunglasses</h6>
