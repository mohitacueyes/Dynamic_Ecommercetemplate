   ...
   <section className="py-4">
      <div className="container">
        ...
        <div className="product-grid">
          <div className="new-arrivals owl-carousel owl-theme position-relative">
            <div className="item">
              <div className="card">
                <div className="position-relative overflow-hidden">
                  ...
                  <a href="javascript:;">
                    <img src="assets/images/products/11.png" className="img-fluid" alt="..." />
                  </a>
                </div>
            ...
            <div className="item">
              <div className="card">
                <div className="position-relative overflow-hidden">
                  ...
                  <a href="javascript:;">
                    <img src="assets/images/products/12.png" className="img-fluid" alt="..." />
                  </a>
                </div>
                <div className="card-body px-0">
                  <div className="d-flex align-items-center justify-content-between">
            ...
            <div className="item">
              <div className="card">
                <div className="position-relative overflow-hidden">
                  ...
                  <a href="javascript:;">
                    <img src="assets/images/products/14.png" className="img-fluid" alt="..." />
                  </a>
                </div>
                <div className="card-body px-0">
                  <div className="d-flex align-items-center justify-content-between">
            ...
            <div className="item">
              <div className="card">
                <div className="position-relative overflow-hidden">
                  ...
                  <a href="javascript:;">
                    <img src="assets/images/products/15.png" className="img-fluid" alt="..." />
                  </a>
                </div>
                <div className="card-body px-0">
                  <div className="d-flex align-items-center justify-content-between">
            ...
            <div className="item">
              <div className="card">
                <div className="position-relative overflow-hidden">
                  ...
                  <a href="javascript:;">
                    <img src="assets/images/products/16.png" className="img-fluid" alt="..." />
                  </a>
                </div>
                <div className="card-body px-0">
                  <div className="d-flex align-items-center justify-content-between">
            ...
            <div className="item">
              <div className="card">
                <div className="position-relative overflow-hidden">
                  ...
                  <a href="javascript:;">
                    <img src="assets/images/products/18.png" className="img-fluid" alt="..." />
                  </a>
                </div>
                <div className="card-body px-0">
                  <div className="d-flex align-items-center justify-content-between">
